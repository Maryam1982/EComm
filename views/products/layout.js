module.exports = ({ content, cart }) => {
  console.log(cart);
  let cartItemsNumber;
  if (cart) {
    cartItemsNumber = cart.items.reduce((acc, item) => {
            ...
            <div class="container navbar-container">
              ...
              <div class="navbar-item">
                <div class="navbar-buttons">
                  ...
                  <div class="navbar-item">
                    <a href="/cart"><i class="fa fa-shopping-cart"><span class="has-text-danger">${cartItemsNumber}</span></i> Cart</a>
                  </div>
                </div>
              </div>
            </div>
